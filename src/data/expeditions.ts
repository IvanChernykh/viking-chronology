...
export const expeditionChapters: ExpeditionChapter[] = [
  {
    ...
    historicalFrame: 'Глава объединяет несколько документированных процессов IX века и не изображает их как одно плавание одной команды.', crewSize: 42,
    requirements: { food: 64, timber: 28, sailcloth: 18 }, accent: '#c56b4e',
    milestones: [
  ...
  },
  {
    ...
    historicalFrame: 'Маршрут показывает долговременный торговый коридор, а не точную трассу одной экспедиции.', crewSize: 34,
    requirements: { food: 58, timber: 38, sailcloth: 12 }, accent: '#71967f',
    milestones: [
  ...
  },
  {
    ...
    historicalFrame: 'Глава соединяет многолетние этапы заселения и разведки. Она не утверждает непрерывность одной команды.', crewSize: 28,
    requirements: { food: 82, timber: 44, sailcloth: 28 }, accent: '#d1b36c',
    milestones: [
